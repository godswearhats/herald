...
$(function(){$(document).on("mouseup",stopRotate);$(".add-unit").on("click",addUnit);$(".update-unit").on("click",updateUnit);$("#add-remote-scenery").on("click",loadRemoteScenery);$("#dump-button").on("click",dumpHTML);$("#slurp-button").on("click",slurpHTML);$("#start-report").on("click",toggleReportState);for(var a=["tower","wall","tree","corner_hill","hill"],b=0;b<a.length;b++)createSceneryButton("img/"+a[b]+".png",a[b].replace("_"," "),!0,"#scenery-manager");createSceneryButton("img/red_arrow.png",
"Player 1",!1,"#report");createSceneryButton("img/blue_arrow.png","Player 2",!1,"#report");$("#control-panel").tabs({activate:function(a,b){$(".unit").draggable("disable");var e=b.newPanel.data("player");e?($(".unit").draggable("disable"),$(".unit.player-"+e).draggable("enable")):$(".unit").draggable("enable")}})});function addPlayerClass(a,b){var c=a.data("player");c&&b.addClass("player-"+c)}
function toggleReportState(){reportStarted?(reportStarted=!1,$("#start-report").text("Start Report (locks scenery)"),$(".scenery").draggable({cancel:".handle"}).resizable({autoHide:!0,aspectRatio:!0})):(reportStarted=!0,$("#start-report").text("Stop Report (unlocks scenery)"),$(".scenery").draggable("destroy").resizable("destroy"))}function loadRemoteScenery(){var a=$("#scenery-url").val(),b=$("#scenery-label").val();createSceneryButton(a,b,!0,"#scenery-manager")}
