...
Math.round(16*(a/25.4))*b;c&&(a+=(b-1)*q);return a}function L(a){var b=c("#"+c(a.target).data("unit")),a=b.data();void 0===a.top&&(a.top=b.offset().top,a.left=b.offset().left);var d=b.attr("id");b.remove();b=p(a.player,d,x(a.player,a));z(b,a)}function m(a){A(a,{ranks:"",files:"",models:"",modelsDead:0,title:"",baseHeight:20,baseWidth:20,looseFormation:!1});c("#unit-manager-player-"+a+" .update-unit").prop("disabled",!0)}function V(a){var a=c("#"+a.data.unitID),b=a.children(".unit-models");c(".unit-models").css({"box-shadow":"3px 3px 8px #222"});
